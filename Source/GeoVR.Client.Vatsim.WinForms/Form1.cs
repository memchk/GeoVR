...
namespace GeoVR.Client.VATSIM.WinForms
{
    public partial class Form1 : MetroFramework.Forms.MetroForm
    {
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            RefreshMapMarkers();
            lblReceivedAudioBytes.Text = (clientManager.ClientStatistics.AudioBytesReceived / 1024).ToString() + " kB";
            lblLastSender.Text = string.Join(" ,", clientManager.networkAudioBuffers.Select(x => x.Callsign));
        }
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            ...
            var frequency = (string)lblFrequency.Text;
